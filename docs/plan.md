...
- [ ] STORY 13.1: Git 저장소와 Vercel 프로젝트를 연결한다 (완료 확인: 배포 기록에서 최신 코드가 성공 상태로 표시됩니다.)
- [ ] STORY 13.2: Supabase Cloud와 배포 환경변수·OAuth 콜백·Kakao 허용 도메인을 연결한다 (완료 확인: 공개 주소에서 두 로그인과 본인 일정 저장이 동작합니다.)
